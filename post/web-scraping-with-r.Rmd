...
So it looks like the Atlanta Hawks and the Chicago Bulls have had some pretty coaches throughout NBA history. Much more analysis can be done with this dataset like which coach has the most wins all-time. Or we can try to make interesting connections like do years of experience correlate with more wins? But I'll leave that to you to find out!
